            ...
            >
              <div className="flex h-full flex-col p-6">
                <div className="flex-1 flex flex-col gap-3">
                  <h3 className="text-4xl md:text-5xl font-bold mb-5 text-accent">{project.title}</h3>
                  <p className="text-xl md:text-2xl mb-6 text-gray-800">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag, tagIndex) => (
                      <span
                        key={tagIndex}
                        className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-xl"
                      >
                        {tag}
                      </span>
                    ))}
